classdef Eb_Grad_Hess
    ...
    methods (Access = public)
        function obj = Eb_Grad_Hess(ne,voronoiRefLen,kappaBar,EI1,EI2)
            obj.ne =ne;
        ...
        function Fb = GetFb(obj,x, m1, m2)
            ...
            for c=2:obj.ne
                ...
                m2f = m2(c,:);
                [dF] = ...
                    obj.GradEb(node0, node1, node2, m1e, m2e, m1f, m2f, ...
                    obj.kappaBar(c, :), obj.voronoiRefLen(c), obj.EI1,obj.EI2);
        ...
        function Jb =GetJb(obj,x,m1,m2)
            ...
            for c=2:obj.ne
                ...
                m2f = m2(c,:);
                [dJ] = ...
                    obj.hessEb(node0, node1, node2, m1e, m2e, m1f, m2f, ...
                    obj.kappaBar(c, :), obj.voronoiRefLen(c), obj.EI1,obj.EI2);
    ...
    methods(Access = private)    
        function [dF] = GradEb(obj,node0, node1, node2, m1e, m2e, m1f, m2f, ...
                         kappaBar,l_k, EI1,EI2)
        %
        ...
        function [dJ] = hessEb(obj,node0, node1, node2,m1e, m2e, m1f, m2f, ...
                              kappaBar, l_k, EI1,EI2)
            % Inputs:
            % node0: 1x3 vector - position of the node prior to the "turning" node
            % node1: 1x3 vector - position of the "turning" node
